...
{
	/// <summary>
	/// Base deserializer configurator for nullable date types
	/// </summary>
	...
	public abstract class DeserializerConfigurationDateTimeStyleFormatProviderNullableBase<TDeserialized, TDeserializerConfigurator> : DeserializerConfigurationBase<TDeserialized?>
		...
		where TDeserializerConfigurator : DeserializerConfigurationDateTimeStyleFormatProviderNullableBase<TDeserialized, TDeserializerConfigurator>
	{
		...
		public DeserializerConfigurationDateTimeStyleFormatProviderNullableBase(BindingConfigurationBase bindingConfiguration)
