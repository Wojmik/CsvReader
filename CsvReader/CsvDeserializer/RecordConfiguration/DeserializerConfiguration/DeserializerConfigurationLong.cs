...
{
	/// <summary>
	/// Deserializer configurator for <see cref="long"/> type
	/// </summary>
	public class DeserializerConfigurationLong : DeserializerConfigurationNumberStyleFormatProviderBase<long, DeserializerConfigurationLong>
	{
		/// <summary>
		/// Constructor
		/// </summary>
		/// <param name="bindingConfiguration">Binding to column configuration object</param>
		public DeserializerConfigurationLong(BindingConfigurationBase bindingConfiguration)
