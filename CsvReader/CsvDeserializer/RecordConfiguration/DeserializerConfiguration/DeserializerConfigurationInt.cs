...
{
	/// <summary>
	/// Deserializer configurator for <see cref="int"/> type
	/// </summary>
	public class DeserializerConfigurationInt : DeserializerConfigurationNumberStyleFormatProviderBase<int, DeserializerConfigurationInt>
	{
		/// <summary>
		/// Constructor
		/// </summary>
		/// <param name="bindingConfiguration">Binding to column configuration object</param>
		public DeserializerConfigurationInt(BindingConfigurationBase bindingConfiguration)
